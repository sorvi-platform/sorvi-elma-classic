...
pub fn build(b: *std.Build) void {
    ...
    const elma_lib = b.addLibrary(.{
        ...
        .root_module = D: {
            ...
            mod.addCSourceFiles(.{
                .files = &.{
                    "abc8.cpp",                        "physics_init.cpp",            "anim.cpp",                    "physics_move.cpp",
                    "src/menu/best_times.cpp",         "src/menu/controls.cpp",       "src/editor/dialog.cpp",       "src/menu/dialog.cpp",
                    "timer.cpp",                       "src/editor/canvas.cpp",       "affine_pic_render.cpp",       "D_PIC.CPP",
                    "canvas.cpp",                      "src/editor/help.cpp",         "src/editor/window.cpp",       "src/editor/tool.cpp",
                    "EDITUJ.CPP",                      "src/editor/topology.cpp",     "flagtag.cpp",                 "src/menu/ball_handler.cpp",
                    "src/menu/ball.cpp",               "src/menu/ball_collision.cpp", "polygon.cpp",                 "wav.cpp",
                    "src/menu/player.cpp",             "src/renderer/render.cpp",     "grass.cpp",                   "src/platform/utils.cpp",
                    "LEJATSZO.CPP",                    "physics_forces.cpp",          "lgr.cpp",                     "level_load.cpp",
                    "main.cpp",                        "src/menu/main.cpp",           "src/menu/external.cpp",       "src/menu/pic.cpp",
                    "src/menu/options.cpp",            "pic8.cpp",                    "piclist.cpp",                 "src/menu/play.cpp",
                    "qopen.cpp",                       "recorder.cpp",                "src/menu/rec_list.cpp",       "src/menu/replay.cpp",
                    "src/menu/replay_cache.cpp",       "src/menu/skip.cpp",           "src/eol/status_messages.cpp", "state.cpp",
                    "segments.cpp",                    "src/menu/intro.cpp",          "physics_collision.cpp",       "level.cpp",
                    "src/log.cpp",                     "src/menu/nav.cpp",            "vect2.cpp",                   "eol_settings.cpp",
                    "sound_engine.cpp",                "keys.cpp",                    "fs_utils.cpp",                "object.cpp",
